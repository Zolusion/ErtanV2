                  ...
                  <div class="col-xl-9 col-lg-9 col-md-9 col-sm-9">
                     <nav class="navigation navbar navbar-expand-md navbar-dark ">
                        ...
                        <div class="collapse navbar-collapse" id="navbarsExample04">
                           ...
                           <div class="sign_btn"><a href="register.php">Sign in</a></div>
                        </div>
                     </nav>
                  </div>
               </div>
         ...
         <div class="container">
            ...
            <div class="row">
               <div class="col-md-4 padding_leri">
                  <div class="car_box">
                     <figure><img src="../img/car_img1.png" alt="#"/></figure>
                     <h3>Hundai</h3>
                  </div>
               </div>
               <div class="col-md-4 padding_leri">
                  <div class="car_box">
                     <figure><img src="../img/car_img2.png" alt="#"/></figure>
                     <h3>Audi</h3>
                  </div>
               </div>
               <div class="col-md-4 padding_leri">
                  <div class="car_box">
                     <figure><img src="../img/car_img3.png" alt="#"/></figure>
                     <h3>Bmw x5</h3>
                  </div>
               </div>
            </div>
                        ...
                        <div class="carousel-item active">
                           <div class="container">
                              <div class="carousel-caption ">
                                 <div class="cross_img">
                                    <figure><img src="../img/cross_img.png" alt="#"/></figure>
                                 </div>
            ...
            <div class="container">
               <div class="row">
                  <div class="col-md-12">
                     ...
                     <div class="cont">
                        <h3> <strong class="multi">Garage</strong>
                           Ertan
                        </h3>
                     </div>
                  </div>
