...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty(trim($_POST["new_password"]))){
        $new_password_err = "Aub geef een nieuw wachtwoord op.";
    } elseif(strlen(trim($_POST["new_password"])) < 6){
        $new_password_err = "Wachtwoord moet minimaal 6 tekens hebben.";
    } else{
    ...
    if(empty(trim($_POST["confirm_password"]))){
        $confirm_password_err = "Aub bevestig wachtwoord.";
    } else{
...
<div class="wrapper">
    ...
    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
        ...
        <div class="form-group">
            ...
            <a class="btn btn-link ml-2" href="index.php">Annuleer</a>
        </div>
    </form>
</div>
</body>
